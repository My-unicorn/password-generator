...
//  This is Prompt instruction for the user to begin
 
window.onload = alert("Welcome! Please click 'Generate password' to start!");
 
// This is Main function = Password Generation
 
function generatePass(){
    var allChars = [];
    var resultPass = "";
 
// This is Set dynamic variables
...
// This is Confirm the rest of character conditions
...
// This is Run for loop to use confirmed information and generate password as a result
